                  ...
                  {user ? (
                    ...
                    <>
                      ...
                      <Link to="/register" className="hidden sm:block">
                        <Button className="bg-gradient-to-r from-primary to-primary/90 hover:from-primary/90 hover:to-primary/80 active:from-primary/80 active:to-primary/70 text-primary-foreground font-semibold text-sm px-4 h-10 rounded-xl transition-all duration-200 hover:scale-[0.98] shadow-lg">
                          Đăng ký
                        </Button>
                      </Link>
                    </>
              ...
              {user ? (
                ...
                <div className="flex gap-2 mt-2">
                  ...
                  <Link
                    ...
                    onClick={() => setIsMenuOpen(false)}
                  >
                    <Button className="w-full bg-gradient-to-r from-primary to-primary/90 text-primary-foreground font-semibold text-sm h-10 rounded-xl shadow-lg">
                      Đăng ký
                    </Button>
                  </Link>
                </div>
