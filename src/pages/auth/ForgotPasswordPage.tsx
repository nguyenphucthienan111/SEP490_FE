      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="bg-white/[0.03] border border-white/[0.08] rounded-2xl p-8 backdrop-blur-xl">
          {!isSubmitted ? (
            <>
              <div className="text-center mb-8">
                <h2 className="font-display font-extrabold text-3xl text-white mb-2">Quên Mật Khẩu?</h2>
            ...
            <div className="text-center py-4">
              ...
              <h2 className="font-display font-extrabold text-2xl text-white mb-2">Email Đã Gửi!</h2>
          ...
          <div className="mt-6 text-center">
            <Link
              to="/login"
              className="inline-flex items-center gap-2 text-[#A8A29E] hover:text-white transition-colors font-body"
            >
