      ...
      <main className="ml-[280px] p-8">
        <div className="max-w-6xl">
              ...
              <DialogContent className="bg-[#0A1628] border-white/[0.08] text-white max-w-2xl">
                ...
                <div className="space-y-4 mt-4">
                  <div className="space-y-2">
                    <Label className="text-[#A8A29E]">Tiêu đề</Label>
                    <Input
                  ...
                  <div className="space-y-2">
                    <Label className="text-[#A8A29E]">Danh mục</Label>
                    <Select
                  ...
                  <div className="space-y-2">
                    <Label className="text-[#A8A29E]">Mô tả ngắn</Label>
                    <Textarea
                  ...
                  <div className="space-y-2">
                    <Label className="text-[#A8A29E]">Nội dung</Label>
                    <Textarea
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
            ...
            <div className="bg-white/[0.03] border border-white/[0.08] rounded-2xl p-5">
              <p className="text-[#A8A29E] text-sm mb-1">Bản nháp</p>
              <p className="font-mono text-3xl font-bold text-yellow-400">
                {mockArticles.filter((a) => a.status === "draft").length}
              </p>
            </div>
            <div className="bg-white/[0.03] border border-white/[0.08] rounded-2xl p-5">
              <p className="text-[#A8A29E] text-sm mb-1">Tổng lượt xem</p>
                      ...
                      <div className="flex items-center gap-2 mt-3">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {article.linkedPlayers.map((player, idx) => (
                            <span key={idx} className="px-2 py-0.5 rounded-full text-xs bg-[#00D9FF]/10 text-[#00D9FF]">
                              {player}
                            </span>
                          ))}
                          {article.linkedMatches.map((match, idx) => (
                            <span key={idx} className="px-2 py-0.5 rounded-full text-xs bg-[#FF4444]/10 text-[#FF4444]">
                              {match}
                            </span>
                          ))}
                        </div>
