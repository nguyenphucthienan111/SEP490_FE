          ...
          <Tabs defaultValue="general" className="space-y-6">
                ...
                <div className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <Label className="text-[#A8A29E]">Tên trang web</Label>
                      <Input
                    ...
                    <div className="space-y-2">
                      <Label className="text-[#A8A29E]">Ngôn ngữ</Label>
                      <Select
                  ...
                  <div className="space-y-2">
                    <Label className="text-[#A8A29E]">Mô tả trang web</Label>
                    <Input
                  ...
                  <div className="space-y-2">
                    <Label className="text-[#A8A29E]">Múi giờ</Label>
                    <Select
            ...
            <TabsContent value="ratings">
              <div className="bg-white/[0.03] border border-white/[0.08] rounded-2xl p-6">
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <Label className="text-[#A8A29E]">Điểm cơ bản</Label>
                      <Input
                    ...
                    <div className="space-y-2">
                      <Label className="text-[#A8A29E]">Số chữ số thập phân</Label>
                      <Select
                    ...
                    <div className="space-y-2">
                      <Label className="text-[#A8A29E]">Điểm tối thiểu</Label>
                      <Input
                    ...
                    <div className="space-y-2">
                      <Label className="text-[#A8A29E]">Điểm tối đa</Label>
                      <Input
            ...
            <TabsContent value="security">
              <div className="bg-white/[0.03] border border-white/[0.08] rounded-2xl p-6">
                ...
                <div className="space-y-6">
                  <div className="space-y-2">
                    <Label className="text-[#A8A29E]">Thay đổi mật khẩu Admin</Label>
                  ...
                  <div className="space-y-4">
                    <Label className="text-[#A8A29E]">API Keys</Label>
                  ...
                  <div className="space-y-4">
                    <Label className="text-[#A8A29E]">Dữ liệu & Backup</Label>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="p-4 rounded-xl bg-white/[0.02] border border-white/[0.05]">
